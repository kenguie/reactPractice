	...
	var Nav = React.createClass({
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					IndexLink,
					{ to: '/', activeClassName: 'Active', activeStyle: { fontWeight: 'bold', color: 'red', textDecoration: 'none' } },
					'Get Weather'
				),
				React.createElement(
					Link,
					{ to: 'About', activeClassName: 'Active', activeStyle: { fontWeight: 'bold', color: 'red', textDecoration: 'none' } },
					'About'
				),
				React.createElement(
					Link,
					{ to: 'Examples', activeClassName: 'Active', activeStyle: { fontWeight: 'bold', color: 'red', textDecoration: 'none' } },
					'Examples'
				)
			);
		}
	...
	var WeatherMessage = React.createClass({
		...
		render: function render() {
			return React.createElement(
				'h3',
				null,
				'This is where the weather message goes'
			);
		}
	});
